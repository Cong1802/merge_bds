                    ...
                    <div>
                        <div class="create-bill">
                            ...
                            <div class="form_create_bill">
                                <form method="" action="">
                                    <div class="d_flex d_sm_block input_form_trahang flex_md_wrap align_c">
                                        <div>
                                        ...
                                        <div class="mr_md_0">
                                            ...
                                            <input type="date" class="time_create" name="">
                                        </div>
                                        <div class="mb_md_0">
                                    ...
                                    <div class="detail_hd align_c d_flex space_b mt_20 mb_20">
                                        <h4>
                                            Chọn hàng hóa trả lại
                                        </h4>

                                        <div class="checkbox">
                                            Trả lại toàn bộ
                                            <input type="checkbox" class="checked_all ver_mid">
                                        </div>
                                    </div>
                                                ...
                                                <tbody>
                                                    <tr class="tr">
                                                        ...
                                                        <td class="d_flex space_b align_c ">
                                                            100.000 
                                                            <span class="dv">VNĐ</span>
                                                        </td>
                                                        <td class="text_a_r">
                                                            4.800.000 VNĐ
                                                        </td>
                                                        <td class="text_a_c checkbox ">
                                                            <input class='input_checkbox input_trahang ver_mid' type="checkbox"><input type="number" class="sl_hangtra"> / 2
                                                        </td>
                                                    </tr>
                                                    <tr class="tr">
                                    ...
                                    <div class="total_hd">
                                        ...
                                        <div class="body_hd overflow_sm">
                                            ...
                                            <div class="d_flex  align_c">
                                                ...
                                                <div>
                                                    <input type="text" class="input_number bg_eee" disabled placeholder ="0 VNĐ">
                                                </div>
                                            </div>
                                            <div class="d_flex  align_c">
                                    ...
                                    <div class="total_haokhau">
                                        <div class="body_hd overflow_sm">
                                            ...
                                            <div class="d_flex space_b align_c">
                                                ...
                                                <div>
                                                    <input type="number" class="input_number" placeholder="0 VNĐ">
                                                </div>
                                            </div>
                                            <div class="d_flex space_b align_c">
                                                <div class="title">Phí trả hàng</div>
                                                <div  class="note_hd">
                                                    <select class="select_ctkm js-states form-control">
                                                    <option></option>
                                                    </select>
                                                </div>
                                                <div>
                                    ...
                                    <div class="d_flex flex_end d_sm_block submit_form mt_20">
                                        <button type="button" onclick="location.href='tra-hang.html'" class="btn-huy">Hủy</button>
                                        <button type="button" class="btn-save-bill">Lưu phiếu</button>
                                        <button type="submit" class="btn-create-pay btn1">Thanh toán</button>
                                    </div>
