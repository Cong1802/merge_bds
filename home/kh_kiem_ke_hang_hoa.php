            ...
            <div class="main">
                <div class="header_all d_flex space_b align_c">
                    <div class="head_title">
                        <a href="">Kho hàng</a> /
                        <a href="">Kiểm kê hàng hóa</a>
                    </div>
                    <?php include('../includes/menu_header.php');  ?>
                </div>
                <div class="main_body">

                    <div class="option d_flex option-kiemke d-xl-column space_b">

                            <Div class="d_flex mt_md_20 mb_xl_20 mb_md_0  mt_sm_10 option-left  d_sm_block">
                                <div class="form_search_kh w_sm_100">
                                ...
                                <div class="mr_20 position_r mr_xl_0 mt_sm_10 mr_lg_0 form_date">
                                    <input type="text" name="dates">
                                    <img src="../images/choose_date.png">
                                </div>
                            </Div>

                            <Div class="d_flex space_b option-right">
                                <div class="choose_option cursor_p position_r">
                                        ...
                                        <div class="list_tacvu item_sort position_a">
                                            <div class="box_list_popup_branch text_a_l">
                                                <p onclick="location.href='tao-phieu-kiem-ke.html'" class="option_tacvu d_flex align_c">Tạo hóa đơn</p>
                                ...
                                <div class="btn-create d-sm-none">
                                    <a href="tao-phieu-kiem-ke.html"><span>+</span> Tạo phiếu kiểm kê</a>
                                </div>
                                <div class="d_flex">
                                ...
                                <tbody>
                                    <tr class="tr">
                                        ...
                                        <tr class="option_bill">
                                           <td colspan="9">
                                            <a class="edit" href="chi-tiet-phieu-kiem-ke.html">Chỉnh sửa/chi tiêt</a>
                                                <a href="">In</a>
                                                <a href="">Xuất file</a>
                                           </td>
                                        </tr>
