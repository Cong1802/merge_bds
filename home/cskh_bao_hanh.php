        ...
        <div class="box_main_all">
            ...
            <div class="main">
                ...
                <div class="main_body">
                    ...
                    <div class="option d_flex space_b align_c option_baohanh">
                    ...
                    <div>
                        <div class="list_customer">
                            ...
                            <table class=" table_cskm table_1024">
                                <thead>
                                    <tr>
                                        <td class="stt">
                                            STT
                                ...
                                <tbody>
                                    <tr class="tr cursor_p" onclick="location.href='chi-tiet-bao-hanh.html'">
                                        <td class="text_a_c">
                                            1
                                        </td>
                                        <td class="mah">
                                            <a href="chi-tiet-bao-hanh.html">PTN0000078</a>
                                        </td>
                                        <td class="mah">
