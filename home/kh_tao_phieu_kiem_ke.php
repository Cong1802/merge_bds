                            ...
                            <div class="form_create_bill">
                                <form method="" action="">
                                    ...
                                    <div class="d_flex flex_end submit_form mt_20">
                                        <button type="button" onclick="location.href='kiem-ke-hang-hoa.html'" class="btn-huy">Hủy</button>
                                        <button type="button" class="btn-save-bill tao-phieu-kiem-ke">Lưu phiếu</button>
                                    </div>
