        ...
        <div class="box_main_all">
            ...
            <div class="main">
                ...
                <div class="main_body">
                    ...
                    <div class="option_left space_b option_left_phieuthu d_sm_block d_flex">
                        ...
                        <div class="choose_option cursor_p position_r">
                            ...
                            <div class="list_tacvu item_sort position_a">
                                <div class="box_list_popup_branch text_a_l">
                                    <p class="option_tacvu btn_phieuchi d_flex align_c">Tạo hóa đơn</p>
                                ...
                                <tbody>
                                    <tr class="tr">
                                        ...
                                        <tr class="option_bill">
                                           <td colspan="14">
                                                <a class="btn-detail-phieu-chi cursor_p">Chi tiết</a>
...
<script>
    ...
    $('.active18').each(function() {
        if ($(this).hasClass('active18')) {
