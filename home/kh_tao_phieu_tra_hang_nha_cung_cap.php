...
<head>
    <title>Tạo phiếu trả hàng nhà cung cấp</title>
    <meta charset="UTF-8">
                            ...
                            <div class="form_create_bill">
                                <form method="" action="">
                                    <div class="d_flex ncc flex_md_wrap align_c">
                                        ...
                                        <div class="select-option-ncc mr_md_0 mt_md_20">
                                    ...
                                    <Div class="overflow_sm">
                                        <div class="d_flex space_b align_c body_hd mt_20 total-375">
                                            ...
                                            <div class="note_hd">
                                                <input type="text" placeholder="Ghi chú" class="input_text w-100">
                                            </div>
                                            <div>
                                    ...
                                    <div class="d_flex flex_end submit_form mt_20">
                                        ...
                                        <button type="button" class="btn-save-bill-ncc luu-phieu-tra-hang btn-save-bill">Lưu phiếu</button>
                                    </div>
