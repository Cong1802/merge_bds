            ...
            <div class="main">
                <div class="header_all d_flex space_b align_c position_r">
                    <div class="head_title">
                        <p>Báo cáo <span>/</span> Sửa chữa</p>
                    </div>
                    <?php include('../includes/menu_header.php');  ?>
                </div>
                <div class="main_body">
                    <div class="bc_sua_chua_xe">
                        ...
                        <div class="choose_branch d_flex space_b align_c mt_20">
                            <p class="font_s24 color_grey font_wB white_s_nw">Báo cáo sửa chữa</p>
                        ...
                        <div class="box_main_body">
                            <div class="box_overview color_grey d_flex space_b">
                                <div class="box_model_count">
                                    <p class="font_s16 font_w500 text_a_c">Xe đã vào xưởng</p>
                                    <p class="font_s30 color_blue mt_10 mb_10 d_flex just_c_c">8<span class="font_s14 mt_15">xe</span> </p>
                                </div>
                                <div class="box_model_count">
                                    <p class="font_s16 font_w500 text_a_c">Xe đã xuất xưởng</p>
                                    <p class="font_s30 color_blue mt_10 mb_10 d_flex just_c_c">15<span class="font_s14 mt_15">xe</span> </p>
                                </div>
                                <div class="box_model_count">
                                    <p class="font_s16 font_w500 text_a_c">Doanh thu sửa chữa</p>
...
<script>
    $('.active24').addClass('active');
    $('.active24').each(function() {
        if ($(this).hasClass('active24')) {
