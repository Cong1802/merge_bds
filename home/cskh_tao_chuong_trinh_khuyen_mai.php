...
<head>
    <title>Tạo chương trình khuyến mại</title>
    <meta charset="UTF-8">
                                    ...
                                    <Div class="d_flex create_ctkm d_sm_block create_km space_b">
                                            ...
                                            <Div>
                                                <div class="w-100 mb_20">
                                                    ...
                                                    <div>
                                                        <input type="text" class="w-100" placeholder="Nhập chương trình khuyến mại">
                                                    </div>
                                                </div>
                                                <div class="w-100 mb_20">
                                                ...
                                                <div class="w-100 d_flex">
                                                    ...
                                                    <button type="button" class="btn_add_branch"><img src="../images/add_infor.png"></button>
                                                </div>
                                            </Div>
