                    ...
                    <div>
                        <div class="create-bill">
                            ...
                            <div class="form_create_bill">
                                <form method="" action="">
                                    <div class="d_flex space_b main_create_hd1 align_c">
                                        <div class="div_1">
                                        ...
                                        <div class="div_4">
                                            ...
                                            <div class="d_flex">
                                                <input type="date" class="mr_20" name="">
                                                <input type="time" name="">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="d_flex w-100 align_c mt_20">
                                        <div class="div_name">
                                    ...
                                    <div class="detail_hd align_c d_flex space_b mt_20">
                                        <h4>
                                            Hóa đơn chi tiết
                                        </h4>
                                        ...
                                        <div class="form_search_hd">
                                            ...
                                            <a href="" class="href btn_create_hanghoa"><img src="../images/add_infor.png"></a>
                                        </div>
                                    ...
                                    <div class="d_flex flex_end submit_form mt_20">
                                        ...
                                        <button type="button" class="btn-create-bill">Tạo hóa đơn</button>
                                        <button type="submit" class="btn-create-pay">Tạo và thanh toán</button>
                                    </div>
