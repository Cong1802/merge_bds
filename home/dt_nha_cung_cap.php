...
$select_nhacungcap = new db_query("SELECT * FROM nhacungcap WHERE true ORDER BY ncc_id DESC");
?>
<!DOCTYPE html>
<html lang="vi">
            ...
            <div class="main">
                <div class="header_all d_flex space_b align_c position_r">
                    <div class="head_title">
                        <p>Đối tác <span>/</span> Nhà cung cấp</p>
                    </div>
                ...
                <div class="main_body">
                    <div class="scx_danh_muc_xe">
                        <div class="head_main_body d_flex space_b">
                            ...
                            <a href="them-moi-doi-tac-nha-cung-cap.html">
                            ...
                            <div id="flex_p_3" class="d_flex flex_end ml_10">
                                ...
                                <div id="" class="toolbar choose_func_480 cursor_p position_r white_s_nw">
                                    <div class="d_flex box_select select_tt space_b align_c">
                                        <p class="p_box_option1 p_output_tt_func_480" data-id="0">Thêm nhà cung cấp</p>
                                    ...
                                    <div class="show_list_popup list_popup_func_480 position_a" style="display: none">
                                        <div class="box_list_popup_stt text_a_l">
                                           <a href="them-moi-doi-tac-nha-cung-cap.html"><p class="option_tt d_flex align_c color_grey">Thêm nhà cung cấp</p></a> 
                        ...
                        <div class="choose_branch d_flex space_b align_c mt_20">
                            <p class="font_s24 color_grey font_wB white_s_nw">Nhà cung cấp</p>
                            ...
                            <div class="main_table_list">
                                <div class="main_table_list_all">
                                    <div class="box_main_table_list">
                                        <table class="table table_doi_tac_nha_cung_cap">
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" class="checked_all"><span class="span_thead"></span></th>
                                                    <th>STT<span class="span_thead"></span></th>
                                                    <th>Mã nhà cung cấp<span class="span_thead"></span></th>
                                                    <th>Tên nhà cung cấp<span class="span_thead"></span></th>
                                                    ...
                                                    <th>Nhóm nhà cung cấp<span class="span_thead"></span></th>
                                                    <th>Mã số thuế</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <?php
                                                $i = 1;
                                                while ($select_ncc = mysql_fetch_assoc($select_nhacungcap->result)) : ?>
                                                <tr class="prev_tr_hide">
                                                    <td class="checkbox_check">
                                                        <input type="checkbox" class="check_box_one">
                                                    </td>
                                                    <td><?= $i; ?></td>
                                                    <td class="color_blue cursor_p font_w500">NCC<?= $select_ncc['ncc_id'] ?></td>
                                                    <td><?= $select_ncc['ncc_name'] ?></td>
                                                    <td><?= $select_ncc['ncc_phone'] ?></td>
                                                    <td><?= $select_ncc['ncc_email'] ?></td>
                                                    <td><?= $select_ncc['ncc_adr_details'] ?></td>
                                                    <td><?= $select_ncc['ncc_gr'] ?></td>
                                                    <td><?= $select_ncc['ncc_taxcode'] ?></td>
                                                </tr>
                                                <?php $i++;
                                                endwhile; ?>
                                            </tbody>
