...
<head>
    <title>Chỉnh sửa phiếu tiếp nhận</title>
    <meta charset="UTF-8">
            ...
            <div class="main">
                <div class="header_all d_flex space_b align_c position_r">
                    <div class="head_title d_flex align_c">
                        ...
                        <p>Sửa chữa xe<span>&nbsp;/&nbsp;</span><a href="/tiep-nhan-xe.html">Tiếp nhận xe</a><span>&nbsp;/&nbsp;</span><a href="chinh-sua-phieu-tiep-nhan.html">Chỉnh sửa phiếu tiếp nhận</a> </p>
                    </div>
                ...
                <div class="main_body">
                    <div class="main_tao_phieu_nhan_xe">
                        <div class="main_create_all">
                            <div class="head_title_main_cre">Chỉnh sửa phiếu tiếp nhận</div>
                                ...
                                <div class="box_create_model_l2">
                                    ...
                                    <div class="d_flex space_b flex_w">
                                        <div class="box_input_infor box_input_infor_l3 position_r">
                                            ...
                                            <select name="sl_name_kh" id="" class="input_infor_tag select2_one2">
                            ...
                            <div class="box_button_function d_flex flex_end">
                                ...
                                <div class="btn_dong_y btn_blue">Cập nhật</div>
                            </div>
                        </div>
                    </div>
                </div>
